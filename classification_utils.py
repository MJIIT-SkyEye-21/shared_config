...
from .classification_config import TILE_SIDE_HEIGHT, TILE_SIDE_WIDTH


def make_classification_model_directory(model_name):
    ts = _get_timestamp_string()
    name = f"{model_name}_cls_{ts}_tile_{TILE_SIDE_WIDTH}_{TILE_SIDE_HEIGHT}"
